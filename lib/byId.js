    ...
    if (payload != null) {
        ...
        if (fetched != null && fetched.includes(action.type)) {
            if (typeof payload === 'object' && typeof payload.entities === 'object') {
                var newEntities_1 = {};
                Object.keys(payload.entities).forEach(function (id) {
                    newEntities_1[id] = __assign(__assign({}, (defaultAttributes || {})), (payload.entities || {})[Number.isNaN(parseInt(id)) ? id : parseInt(id, 10)]);
                });
        ...
        if (confirmed != null && confirmed.includes(action.type)) {
            if (typeof payload === 'object') {
                ...
                if (typeof oldId !== 'undefined' && typeof newId !== 'undefined' && typeof state[oldId] !== 'undefined') {
                    ...
                    newState_3[newId] = __assign(__assign(__assign({}, newState_3[oldId]), extra), { id: newId });
                    delete newState_3[oldId];
                    return newState_3;
                }
                var newState_4 = {};
                Object.keys(state).forEach(function (key) {
                    newState_4[key] = __assign({}, state[key]);
                });
                return newState_4;
            }
        }
